...
public final class ALparexprparPrimaryExp extends PPrimaryExp
{
    private TLParenthese _lParenthese_;
    private PExp _exp_;
    private TRParenthese _rParenthese_;

    public ALparexprparPrimaryExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALparexprparPrimaryExp(
    ...
    {
        ((Analysis) sw).caseALparexprparPrimaryExp(this);
    }
