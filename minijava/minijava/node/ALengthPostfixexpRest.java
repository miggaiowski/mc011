...
public final class ALengthPostfixexpRest extends PPostfixexpRest
{
    private PExp _exp_;
    private TDot _dot_;
    private TLength _length_;

    public ALengthPostfixexpRest()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALengthPostfixexpRest(
    ...
    {
        ((Analysis) sw).caseALengthPostfixexpRest(this);
    }
