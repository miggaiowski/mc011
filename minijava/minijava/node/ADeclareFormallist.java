...
public final class ADeclareFormallist extends PFormallist
{
    private PType _type_;
    private TId _id_;
    private final LinkedList<PFormalrest> _formalrest_ = new LinkedList<PFormalrest>();

    public ADeclareFormallist()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseADeclareFormallist(this);
    }
